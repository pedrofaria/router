...
abstract class DispatcherTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testFoundDispatches($method, $uri, $callback, $handler, $argDict) {
        $dispatcher = \Router\simpleDispatcher($callback, $this->generateDispatcherOptions());
     ...
     * @expectedException Router\Exception\HttpNotFoundException
     */
     ...
     * @expectedException Router\Exception\HttpMethodNotAllowedException
     */
    ...
    /**
     * @expectedException \Router\Exception\BadRouteException
